...
def login_page():
    ...
    if st.session_state["logged_in"]:
        with st.container(): # *** NOVO: Container para a área de perfil ***
            ...
            # *** NOVO: Exibir informações de perfil ***
            st.markdown(f"**Username:** {st.session_state['username']}")
            st.markdown(f"**Nome:** {st.session_state['user_nome'] if st.session_state['user_nome'] else '-'}") # Usar '-' se não houver nome
            st.markdown(f"**Email:** {st.session_state['user_email'] if st.session_state['user_email'] else '-'}") # Usar '-' se não houver email
            ...
            if st.session_state["is_admin"]:
                ...
                st.write("Aqui poderá ver as suas informações de perfil.")
